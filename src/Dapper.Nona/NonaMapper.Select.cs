...
namespace Dapper.Nona
{
    public static partial class NonaMapper
    {
        ...
        /// </returns>
        public static IEnumerable<T> Select<T>(this IDbConnection connection, Expression<Func<T, bool>> predicate, IDbTransaction transaction = null, bool buffered = true)
        {
            var sql = BuildSelectSql(predicate, out var parameters);
            LogQuery<T>(sql);
            return connection.Query<T>(sql, parameters, transaction, buffered);
        }
        ...
        /// <paramref name="predicate"/>.
        /// </returns>
        public static Task<IEnumerable<T>> SelectAsync<T>(this IDbConnection connection, Expression<Func<T, bool>> predicate, IDbTransaction transaction = null)
        {
            var sql = BuildSelectSql(predicate, out var parameters);
            LogQuery<T>(sql);
        ...
        /// <paramref name="predicate"/>.
        /// </returns>
        public static T FirstOrDefault<T>(this IDbConnection connection, Expression<Func<T, bool>> predicate, IDbTransaction transaction = null)
        {
            var sql = BuildSelectSql(predicate, out var parameters);
            LogQuery<T>(sql);
        ...
        /// <paramref name="predicate"/>.
        /// </returns>
        public static Task<T> FirstOrDefaultAsync<T>(this IDbConnection connection, Expression<Func<T, bool>> predicate, IDbTransaction transaction = null)
        {
            var sql = BuildSelectSql(predicate, out var parameters);
            LogQuery<T>(sql);
        ...
        /// <paramref name="predicate"/>.
        /// </returns>
        public static IEnumerable<T> SelectPaged<T>(this IDbConnection connection, Expression<Func<T, bool>> predicate, int pageNumber, int pageSize, IDbTransaction transaction = null, bool buffered = true)
        {
        ...
        /// <paramref name="predicate"/>.
        /// </returns>
        public static Task<IEnumerable<T>> SelectPagedAsync<T>(this IDbConnection connection, Expression<Func<T, bool>> predicate, int pageNumber, int pageSize, IDbTransaction transaction = null)
        {
            var sql = BuildSelectPagedQuery(connection, predicate, pageNumber, pageSize, out var parameters);
            LogQuery<T>(sql);
            return connection.QueryAsync<T>(sql, parameters, transaction);
