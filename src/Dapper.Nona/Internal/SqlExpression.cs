...
namespace Dapper.Nona.Internal
{
    ...
    internal class SqlExpression<TEntity>
    {
        ...
        protected virtual object VisitUnary(UnaryExpression expression)
        {
            switch (expression.NodeType)
            {
                case ExpressionType.Not:
                    ...
                    if (memberExpression != null && NonaMapper.Resolvers.Properties(memberExpression.Expression.Type).Any(p => p.PropertyInfo.Name == (string)o))
                    {
                        o = $"{o} = '1'";
                    }
        ...
        {
            return NonaMapper.Resolvers.Column(new NonaProperty(expression.Expression.Type, expression.Member as PropertyInfo));
        }
        ...
        /// <returns>
        /// The expression operand equivalent of the <paramref name="expressionType" />.
        /// </returns>
